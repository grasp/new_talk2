...
database_name = case Padrino.env
  when :development then 'new_talk_development'
  when :production  then 'new_talk_production'
  when :test        then 'new_talk_test'
end
